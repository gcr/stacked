...
class EventManager:
    """
        This class handles most of the communication between the
    ...
    def register_listener(self, event, object):
        """
            Subscribes the object to every event of eventtype. If
            eventtype gets triggered, the object will be notified
            through a call to object.Notify(event).
        """
